...
export default function Header2({ navColor, logo, scroll, navToggled, navHandle }: any) {
    return (
        <>
                        ...
                        <div className="col-auto">
                            <div className="header__right">
                                <div className="md:d-none">
                                    <Link href="/login" className="button -sm -white-20 rounded-8 text-white">Sign In</Link>
                                </div>
