...
export default function Header({ navColor, logo, scroll, navToggled, navHandle }: any) {
                            ...
                            <div className="header__right">
                                <div className="md:d-none">
                                    {status === "authenticated" ? (
                                        <button onClick={() => signOut({ callbackUrl: '/login' })} className="button -sm -dark text-white ml-12">
                                            Log out
                                        </button>
                                    ) : (
                                        <>
                                            <Link href="/register" className="button -sm -outline-light-dark sm:d-none">Sign up</Link>
                                            <Link href="/login" className="button -sm -dark text-white ml-12">Log in</Link>
                                        </>
                                    )}
