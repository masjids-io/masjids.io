        ...
        <>
            ...
            <div className="works-row masonry -col-3  pt-60 sm:pt-40 js-masonry js-masonry-no-filter">
                ...
                <div className="masonry__item -no-ratio  e_commerce">
                    <div className="h:zoom">
                        <div className="ratio ratio-64:55 hover-group overflow-hidden">
                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="absolute-full-center h:zoom__item object-fit-cover z-1" src="/img/portfolio/cards/1.jpg" alt="image" />
                ...
                <div className="masonry__item -no-ratio  e_commerce digital_design">
                    <div className="h:zoom">
                        <div className="ratio ratio-64:55 hover-group overflow-hidden">
                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="absolute-full-center h:zoom__item object-fit-cover z-1" src="/img/portfolio/cards/2.jpg" alt="image" />
                            <div className="d-flex justify-center items-center absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="bg-dark-1 opac-80 absolute-full-center" />
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="text-center relative z-2">
                ...
                <div className="masonry__item -no-ratio  web_design digital_design branding">
                    <div className="h:zoom">
                        <div className="ratio ratio-64:55 hover-group overflow-hidden">
                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="absolute-full-center h:zoom__item object-fit-cover z-1" src="/img/portfolio/cards/3.jpg" alt="image" />
                            <div className="d-flex justify-center items-center absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="bg-dark-1 opac-80 absolute-full-center" />
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="text-center relative z-2">
                ...
                <div className="masonry__item -no-ratio  e_commerce branding">
                    <div className="h:zoom">
                        <div className="ratio ratio-64:55 hover-group overflow-hidden">
                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="absolute-full-center h:zoom__item object-fit-cover z-1" src="/img/portfolio/cards/4.jpg" alt="image" />
                            <div className="d-flex justify-center items-center absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="bg-dark-1 opac-80 absolute-full-center" />
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="text-center relative z-2">
                ...
                <div className="masonry__item -no-ratio  web_design digital_design branding">
                    <div className="h:zoom">
                        <div className="ratio ratio-64:55 hover-group overflow-hidden">
                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="absolute-full-center h:zoom__item object-fit-cover z-1" src="/img/portfolio/cards/5.jpg" alt="image" />
                            <div className="d-flex justify-center items-center absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="bg-dark-1 opac-80 absolute-full-center" />
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="text-center relative z-2">
                ...
                <div className="masonry__item -no-ratio  web_design e_commerce branding">
                    <div className="h:zoom">
                        <div className="ratio ratio-64:55 hover-group overflow-hidden">
                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="absolute-full-center h:zoom__item object-fit-cover z-1" src="/img/portfolio/cards/6.jpg" alt="image" />
                            <div className="d-flex justify-center items-center absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="bg-dark-1 opac-80 absolute-full-center" />
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="text-center relative z-2">
                ...
                <div className="masonry__item -no-ratio  e_commerce">
                    <div className="h:zoom">
                        <div className="ratio ratio-64:55 hover-group overflow-hidden">
                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="absolute-full-center h:zoom__item object-fit-cover z-1" src="/img/portfolio/cards/7.jpg" alt="image" />
                            <div className="d-flex justify-center items-center absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="bg-dark-1 opac-80 absolute-full-center" />
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="text-center relative z-2">
                ...
                <div className="masonry__item -no-ratio  e_commerce digital_design">
                    <div className="h:zoom">
                        <div className="ratio ratio-64:55 hover-group overflow-hidden">
                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="absolute-full-center h:zoom__item object-fit-cover z-1" src="/img/portfolio/cards/8.jpg" alt="image" />
                            <div className="d-flex justify-center items-center absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="bg-dark-1 opac-80 absolute-full-center" />
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="text-center relative z-2">
                ...
                <div className="masonry__item -no-ratio  digital_design web_design branding">
                    <div className="h:zoom">
                        <div className="ratio ratio-64:55 hover-group overflow-hidden">
                            <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="absolute-full-center h:zoom__item object-fit-cover z-1" src="/img/portfolio/cards/9.jpg" alt="image" />
                            <div className="d-flex justify-center items-center absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="bg-dark-1 opac-80 absolute-full-center" />
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="text-center relative z-2">
