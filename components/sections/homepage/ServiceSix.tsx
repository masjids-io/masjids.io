                ...
                <div className="container">
                    ...
                    <div className="row y-gap-32 pt-60 sm:pt-40">
                        <div className="col-lg-4 col-sm-6">
                            <div className="py-48 px-40 bg-white shadow-card br-rounded-32">
                                ...
                                <p className="mt-10">Great free UI package based on Bootstrap 5 that includes the most important components and features.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-sm-6">
                            <div className="py-48 px-40 bg-white shadow-card br-rounded-32">
