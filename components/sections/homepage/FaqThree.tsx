        ...
        <>
            <section className="layout-pt-lg layout-pb-lg relative">
                <div className="absolute-full-center z-1">
                    <div className="bg-image js-lazy" style={{ backgroundImage: 'url("../img/shapes/rect.png")' }} />
                </div>
                <div className="js-rellax z-2 shape -top -left-0 md:d-none">
                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/img/home-4/shapes/2.png" alt="shape" />
                </div>
                <div className="js-rellax z-2 shape -bottom -right-0 md:d-none">
                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/img/home-4/shapes/3.png" alt="shape" />
                </div>
